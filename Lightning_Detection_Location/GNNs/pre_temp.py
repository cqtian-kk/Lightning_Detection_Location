...
# model_path = './mode_path/mode_PLAN2_lstm_1000dconv14/model_481-0.9730697852678788.pt'
...
# pre_dataset = MyGNNDataset(temp_data, temp_label, edge_index.T)
# temp_datatime = train_label
# # pre_dataset = MyGNNDataset(val_data, val_label, edge_index.T)
# # temp_datatime = val_label
...
np.savez('./gnnresult/gnnresult2_271_10_raw.npz',d1 = result, d2 = temp_datatime)
print(result[0])
print(result[1])
print(temp_datatime[0])
