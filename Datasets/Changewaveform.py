...
noise_sample2 = Createbignoise(noises_sample2, 8400)
data_noises = reshape_and_randomize(noise_sample2,(8400,6,1000))

# ligdata_c is Type 1
ligdata_c = np.load('./data_clear/data0num20.npz')
...
# ligdata_c is Type 1
np.savez('./data_clear/data0num20_Type1.npz',d1 = ligdata_c, d2 = label_clear)

# Changewaveform to Type 2
for i in range(8400):
    data2[i] = Scalenoiseandadd(ligdata_clear[i],data_noises[i]) 
np.savez('./data_clear/data0num20_Type2',d1 = data2, d2 = label_clear)
...
np.savez('./data_clear/data0num20_Type3.npz',d1 = data3, d2 = label_clear)
...
np.savez('./data_clear/data0num20_Type4.npz',d1 = data4, d2 = label_clear)
...
np.savez('./data_clear/data0num20_Type5.npz',d1 = data5, d2 = label_clear)
